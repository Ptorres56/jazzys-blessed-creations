...
import belleBirthday from "../assets/gallery/belle-birthday-banner.jpeg";
import easterEvent from "../assets/gallery/easter-event-banner.jpeg";
import easterRisen from "../assets/gallery/easter-risen-banner.jpeg";
import grecaGathering from "../assets/gallery/greca-gathering-banner.jpeg";
import jeremiahBirthday from "../assets/gallery/jeremiah-birthday-banner.jpeg";
import mothersDay from "../assets/gallery/mothers-day-banner.jpeg";
import scottieBirthday from "../assets/gallery/scottie-birthday-banner.jpeg";
...
function Gallery() {
  ...
  // ✅ All images go here
  const banners = [
    { src: sheStands, alt: "She Stands Banner" },
    { src: happyNoggin, alt: "Happy Noggin Banner" },
    { src: avaBirthday, alt: "Ava Birthday Banner" },
    { src: belleBirthday, alt: "Belle Birthday Banner" },
    { src: easterEvent, alt: "Easter Event Banner" },
    { src: easterRisen, alt: "Easter Risen Banner" },
    { src: grecaGathering, alt: "Greca Gathering Banner" },
    { src: jeremiahBirthday, alt: "Jeremiah Birthday Banner" },
    { src: mothersDay, alt: "Mother's Day Banner" },
    { src: scottieBirthday, alt: "Scottie Birthday Banner" },
  ];
