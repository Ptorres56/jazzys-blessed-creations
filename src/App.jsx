...
import ColoringPages from "./pages/ColoringPages"; // NEW IMPORT
    ...
    <Router>
      <Routes>
        ...
        <Route path="/" element={<Layout />}>
          ...
          <Route path="banner-pricing" element={<BannerPricing />} />
          <Route path="book-here" element={<BookHere />} />
          <Route path="shop" element={<Shop />} />
          <Route path="coloring-pages" element={<ColoringPages />} /> {/* NEW ROUTE */}
